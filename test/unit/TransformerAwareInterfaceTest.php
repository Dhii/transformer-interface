...
use Dhii\Transformer\TransformerAwareInterface as TestSubject;
 ...
 * @since [*next-version*]
 */
class TransformerAwareInterfaceTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Transformer\TransformerAwareInterface';
