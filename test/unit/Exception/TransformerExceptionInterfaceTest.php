...
use Dhii\Transformer\Exception\TransformerExceptionInterface as TestSubject;
...
class TransformerExceptionInterfaceTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Transformer\Exception\TransformerExceptionInterface';
