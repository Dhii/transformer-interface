...
namespace Dhii\Transformer\Exception\UnitTest;

use Dhii\Transformer\Exception\CouldNotTransformExceptionInterface as TestSubject;
...
class CouldNotTransformExceptionInterfaceTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Transformer\Exception\CouldNotTransformExceptionInterface';
